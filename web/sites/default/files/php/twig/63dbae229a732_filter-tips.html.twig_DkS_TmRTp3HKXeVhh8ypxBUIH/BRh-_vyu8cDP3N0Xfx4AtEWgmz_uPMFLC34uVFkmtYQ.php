...
class __TwigTemplate_b49798958af3904bdf2dc37776786f79 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "C:\\xampp3\\htdocs\\php-advanced-projects\\drupal_test_dir\\web\\core\\themes\\olivero\\templates\\filter\\filter-tips.html.twig");
    }
